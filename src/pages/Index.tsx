  ...
  return (
    <div className="min-h-screen bg-white font-['Inter']">
      ...
      <Dialog open={isContactDialogOpen} onOpenChange={setIsContactDialogOpen}>
        <DialogContent className="sm:max-w-xl border-2 border-gray-100">
          <DialogHeader>
            <DialogTitle className="text-2xl md:text-3xl font-['Poppins'] font-black text-center mb-2">
              <span className="text-[#FF6B35]">Свяжитесь</span> <span className="text-[#00B4A3]">с нами</span>
            </DialogTitle>
            <div className="w-16 h-1 bg-gradient-to-r from-[#FF6B35] to-[#00B4A3] mx-auto drop-shadow-md"></div>
          </DialogHeader>
          
          <div className="grid grid-cols-2 md:grid-cols-3 gap-3 mt-4">
            <button
              onClick={() => { handleWhatsAppClick(); setIsContactDialogOpen(false); }}
              className="group bg-white border-2 border-gray-100 hover:border-[#00B4A3] rounded-2xl p-4 shadow-md hover:shadow-xl transition-all duration-300 hover:scale-105 flex flex-col items-center gap-2"
            >
              <div className="bg-[#00B4A3]/10 group-hover:bg-[#00B4A3]/20 rounded-xl p-3 transition-colors">
            ...
            >
              ...
              <span className="font-bold text-sm text-slate-800">VK</span>
            </button>
            ...
            <button
              ...
              className="group bg-white border-2 border-gray-100 hover:border-[#00B4A3] rounded-2xl p-4 shadow-md hover:shadow-xl transition-all duration-300 hover:scale-105 flex flex-col items-center gap-2"
            >
              <div className="rounded-full overflow-hidden w-12 h-12 ring-2 ring-[#00B4A3]/20 group-hover:ring-[#00B4A3]/40 transition-all">
                <img 
              ...
              <span className="font-bold text-sm text-slate-800">Max</span>
            </button>
            ...
            >
              ...
              <span className="font-bold text-sm text-slate-800">Telegram</span>
            </button>

            <button
              onClick={() => { window.location.href = 'tel:+79235335301'; setIsContactDialogOpen(false); }}
              className="group bg-white border-2 border-gray-100 hover:border-[#FF6B35] rounded-2xl p-4 shadow-md hover:shadow-xl transition-all duration-300 hover:scale-105 flex flex-col items-center gap-2"
            >
              <div className="bg-[#FF6B35]/10 group-hover:bg-[#FF6B35]/20 rounded-xl p-3 transition-colors">
                <Icon name="Phone" size={24} className="text-[#FF6B35]" />
              </div>
              <span className="font-bold text-sm text-slate-800">Позвонить</span>
            </button>
            ...
            >
              <div className="bg-[#00B4A3]/10 group-hover:bg-[#00B4A3]/20 rounded-xl p-3 transition-colors">
                <Icon name="Mail" size={24} className="text-slate-700" />
              </div>
              <span className="font-bold text-sm text-slate-800">Форма связи</span>
            </button>
          </div>
